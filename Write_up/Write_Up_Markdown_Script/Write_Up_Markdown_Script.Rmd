...
abstract: |
  ...
  interconnected methodological choices: the value of the performance goal, the confidence 
  interval method used to construct the decision rule, and the sample size calculation 
