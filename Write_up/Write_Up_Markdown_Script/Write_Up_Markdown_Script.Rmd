...
This study is motivated by that problem. Using the BioMimics 3D vascular stent trial as a case study, it examines how performance goal selection, confidence interval choice assumptions underlying the sample size calculation interact to influence the design requirements and the conclusions in a single-arm medical device setting [@schumi_through_2011; @international_council_for_harmonisation_statistical_1998; @wang_leveraging_2021].
