...
- The upper/lower confidence interval bounds — not the point estimate — were proposed to the regulators as the performance goal thresholds.

- With only 3 studies available, confidence intervals are wide — conservative.
...
# Next Steps {background-color="#5A3A6E"}
